    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white">
        <div class="page-wrapper">
                    ...
                    <div class="page-content">
                        ...
                        <div class="row">
                            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                <a class="dashboard-stat dashboard-stat-v2 blue" href="customerform.php">
                                    <div class="visual">
                                    ...
                                    <div class="details">
                                        <div class="number">
                                            <?php 
                                                $gettotcustomers = mysqli_query($connect, "select count(*) as c from tbl_customers");
                                                $restotcustomers = mysqli_fetch_array($gettotcustomers);
                                            
                                            ?>
                                            <span data-counter="counterup" data-value="<?php echo $restotcustomers['c']; ?>"><?php echo $restotcustomers['c']; ?></span>
                                        </div>
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                <a class="dashboard-stat dashboard-stat-v2 red" href="#">
                                    ...
                                    <div class="details">
                                        <div class="number">
                                            <?php 
                                                $gettotcustomers = mysqli_query($connect, "select count(*) as c from tbl_customers where assignedto = ''");
                                                $restotcustomers = mysqli_fetch_array($gettotcustomers);
                                            
                                            ?>
                                            <span data-counter="counterup" data-value="<?php echo $restotcustomers['c']; ?>"><?php echo $restotcustomers['c']; ?></span></div>
                                        <div class="desc"> Un Assigned Customers </div>
                                    </div>
                                </a>
                            </div>
                            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                <a class="dashboard-stat dashboard-stat-v2 green" href="#">
                                    ...
                                    <div class="details">
                                        <div class="number">
                                             <?php 
                                                $gettotcustomers = mysqli_query($connect, "select count(*) as c from tbl_customers where workstatus != 'Completed'");
                                                $restotcustomers = mysqli_fetch_array($gettotcustomers);
                                            
                                            ?>
                                            <span data-counter="counterup" data-value="<?php echo $restotcustomers['c']; ?>"><?php echo $restotcustomers['c']; ?></span>
                                        </div>
                                        <div class="desc">Pending Works</div>
                                    </div>
                                </a>
                            </div>
                            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                <a class="dashboard-stat dashboard-stat-v2 purple" href="#">
                                    ...
                                    <div class="details">
                                        <div class="number"> <?php 
                                                $gettotcustomers = mysqli_query($connect, "select count(*) as c from tbl_customers where createdon = '$cdate'");
                                                $restotcustomers = mysqli_fetch_array($gettotcustomers);
                                            
                                            ?>
                                            <span data-counter="counterup" data-value="<?php echo $restotcustomers['c']; ?>"></span></div>
                                        <div class="desc">Works Created Today </div>
                                    </div>
                                </a>
                            </div>
                        </div>
            ...
            <div class="page-footer">
                <div class="page-footer-inner"> 2016 &copy; SREETECH By
                    <a target="_blank" href="www.sreetech.in">SREETECH</a> &nbsp;|&nbsp;
                    <a href="www.sreetech.in" title="SREE TECH" target="_blank">SREETECH!</a>
                </div>
